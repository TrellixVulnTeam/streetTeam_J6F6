...
for eventauto in tbody.find_all('tr', class_ = 'eventauto'):
    ...
    if band_name == '! Scarlet Drive !':
        band_name = 'Scarlet Drive'
    
    if band_name == "!  Jack'D Up !":
        band_name = "Jack'D Up"
...
#Clean Up Date String
    ...
    #Checks to make sure there is enough data in the string_array to make a date out of
